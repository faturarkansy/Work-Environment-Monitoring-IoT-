    ...
    <div class="min-h-screen bg-gray-100">
        <nav class="border-b border-gray-100 bg-white shadow-sm">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div
                    class="flex items-center justify-between lg:pt-4 lg:pb-2 p-4"
                >
                    ...
                    <div class="flex items-center space-x-2 sm:hidden">
                        <div
                            class="text-xs font-bold text-gray-700 bg-gray-50 px-3 py-2 rounded-lg border border-gray-100 truncate max-w-[120px]"
                        >
                            {{ $page.props.auth.user.name }}
                        </div>
                ...
                >
                    <div class="flex justify-center w-full">
                        <div class="space-x-6 sm:-my-px sm:flex h-12">
                            ...
                            <NavLink
                                :href="route('all-workers.index')"
                                :active="route().current('all-workers.index')"
                                class="text-lg font-bold"
                            >
                                All Workers
                            </NavLink>
